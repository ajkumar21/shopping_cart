...
describe('Total Price Calculation', () => {
  it('should show subtotal, savings, total savings and grand total', () => {
    ...
    cy.get(':nth-child(3) > .card-body > .btn').click();
    cy.get(
      '#root > :nth-child(1) > :nth-child(2) > :nth-child(2) > :nth-child(1)'
    ).should('have.text', 'Subtotal:£9.78');
    ...
    cy.get(':nth-child(2) > :nth-child(2) > :nth-child(7)').should(
      'have.text',
      'Total Savings: '
    );
    cy.get(':nth-child(2) > :nth-child(8)').should('have.text', '-£1.80');
